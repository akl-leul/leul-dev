    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full mt-16">
        ...
        <main className="flex-1 p-6 bg-indigo-50/50 min-h-screen">
          ...
          {activeTab === "home" && (
            <div className="space-y-6">
              <HomeContentEditor content={homeContent} onUpdate={fetchData} />
            </div>
          )}
          ...
          {activeTab === "about" && (
            <div className="space-y-6">
              <AboutContentEditor profile={profile} onUpdate={fetchData} />
            </div>
          )}
          ...
          {activeTab === "contact" && (
            <div className="space-y-6">
              <ContactContentEditor
                contactInfo={{
                  email: profile?.email || "layfokru@gmail.com",
                  phone: "+251963889227",
                  location: profile?.location || "Addis Ababa, Ethiopia",
                }}
                onUpdate={(info) => {
                  if (profile) {
                    setProfile({ ...profile, email: info.email, location: info.location });
                  }
                }}
              />
            </div>
