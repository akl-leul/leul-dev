  ...
  return (
    ...
    <section 
      ...
      style={{
       ...
       backgroundRepeat: 'no-repeat, no-repeat',     // no-repeat for gradient + image
  backgroundSize: 'cover, cover',                // cover for gradient + image
  backgroundPosition: 'center, center',          // center for gradient + image
  
  backgroundAttachment: 'fixed, fixed',      // fixed for gradient + image
